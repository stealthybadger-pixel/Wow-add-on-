...
local function CreateSlot(index)
	...
	-- 7px health bar anchored directly above powerBar with exact matching X=48 to 209 left/right alignment (Y=5 to 12)
	local healthBar = CreateFrame("StatusBar", nil, f)
	healthBar:SetPoint("BOTTOMLEFT", f, "BOTTOMLEFT", ROLE_COLUMN_WIDTH + 2, 5)
